...
export default {
  ...
  setup() {
    ...
    .then(res=>{
      ...
      imagePath.value = 'http://localhost:8080/static/image/' + res.data.product.thumbnail;
      infoImage.value = 'http://localhost:8080/static/image/' + res.data.product.infoImage;
